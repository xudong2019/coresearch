...
tagNames = ['跳空高开','突破1年新高(开盘)','突破3个月新高(开盘)','均线多头排列','MACD高于DEA','MACD大于0','交易量放大2倍',
            '流通市值大于100亿','流通市值大于250亿','流通市值大于500亿','流通市值小于100亿','流通市值小于50亿','流通市值小于25亿'
           ]
tagMapper={
    '跳空高开':'TagTiaoKongGaoKai',
    '突破1年新高(开盘)':'TagBreak1YHighOpen',
    '突破3个月新高(开盘)':'TagBreak3MHighOpen',
    '均线多头排列':'tagJunXianDuoTouPaiLie',
    'MACD高于DEA':'tagMACDDiffAboveZero',
    'MACD大于0':'tagMACDDiffAboveZero',
    '交易量放大2倍':'tagValumeDouble',
    '流通市值大于100亿':'tagCirculateMarketValueBiggerThan100Y',
    '流通市值大于250亿':'tagCirculateMarketValueBiggerThan250Y',
    '流通市值大于500亿':'tagCirculateMarketValueBiggerThan500Y',
    '流通市值小于100亿':'tagCirculateMarketValueSmallerThan100Y',
    '流通市值小于50亿':'tagCirculateMarketValueSmallerThan50Y',
    '流通市值小于25亿':'tagCirculateMarketValueSmallerThan25Y',
    '季度净利润连续三年大于1亿'：'tagNetProfit3YBiggerThan100M',
    '净利润增速连续三年大于20%'：'tagNetProfitGrowth3YBiggerThan20P'
}
